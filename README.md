...
После двух лет работы я решил углубиться в программирование. Прошёл интенсив в «Школе 21» от Сбера и успешно перешёл на этап основного обучения, где пробовал себя во многих направлениях и языках програамирования: 
- C/С++;
- Python;
- Golang;
- Data Science.  

Но больше всего меня зацепила backend‑разработка на языке Golang!
